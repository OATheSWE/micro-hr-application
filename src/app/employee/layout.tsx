...
export default function EmployeeLayout({
  ...
  const { state, logout, isEmployee } = useAuth()
  ...
  useEffect(() => {
    if (!state.isLoading && !state.isAuthenticated) {
      router.push('/')
    } else if (!state.isLoading && state.isAuthenticated && !isEmployee()) {
      router.push('/admin/dashboard')
    }
  }, [state.isLoading, state.isAuthenticated, state.user, router, isEmployee])
  ...
  if (!state.isAuthenticated || !isEmployee()) {
    return null
  }
